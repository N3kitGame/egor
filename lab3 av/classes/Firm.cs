...
namespace lab3_av
{
    ...
    public class Firm
    {
        ...
        //словарь пользовательских полей
        ...
        //Добавление котакта для подфирмы через параметр
        ...
        //Добавление контакта для подфирмы через экземпляр
        ...
        public void AddField(string fieldName)
        {
            ...
            {
                //неправильно, написать исключение
